          ...
          <section class="fstView">
            <div class="fstView-keyvisual FV-Mask">
              ...
              <div class="FV-FlexBox">
                  <hgroup>
                      <h1>「高級輸入車専門」レンタカー</h1>
                      <h2><span>SVサポート運営</span><br class="sp-mode">SV RENTACAR</h2>
              ...
              <div class="cv_box">
                  <address>
                      ...
                      ※FAXは24時間受付<br>
                      <h6>〒581-0055 大阪府八尾市跡部南の町２－１－１５</h6>
        ...
        <section class="content" id="menu">
              ...
              <div class="emerge">
                ...
                <p>SV RENTACARでは、高級輸入車を中心としたレンタカーをお取扱いしております。<br>
                    コンパクト/大型SUV、スポーティなショートワゴンから本格的プレミアムスポーツカーに至るまで、幅広い車種をご用意致しております。<br>
                  下記メーカーロゴマークよりお進みください。</p>
                <ul class="flexbox FB-Brand">
                  <li class="brand-teaser">
                    <a href="/SV_rentacar/resources/views/Maserati.blade.php"><img src='/SV_rentacar/storage/images/maker_button/マセラッティ.png'></a>
                  </li>
                  <li class="brand-teaser">
                    <a href="#porsche"><img src='/SV_rentacar/storage/images/maker_button2/PORSCHEロゴ.png'></a>
                  </li>
                  <li class="brand-teaser">
                    <a href="#bmw"><img src='/SV_rentacar/storage/images/maker_button3/BMWロゴ.png'></a>
                  </li>
                  <!--li class="brand-teaser">
                    <a href="#jaguar"><span>JAGUAR</span><i class="fas fa-angle-down"></i></a>
                  </li-->
                  <li class="brand-teaser">
                    <a href="#audi"><img src='/SV_rentacar/storage/images/maker_button4/Audiロゴ.png'></a>
                  </li>
                  <li class="brand-teaser">
                    <a href="#benz"><img src='/SV_rentacar/storage/images/maker_button5/Mercedes-Benzロゴ.png'></a>
                  </li>
                  <style>
                    .brand-teaser {
                      img { width: 5vw; 
                  ...
                  <div class="flexbox">
                      ...
                      <div class="col clm50">
                        ...
                        <ul class="ul_summary">
                            ...
                            <li>Mail：<script type="text/javascript">mailadress("SV_rentacar", "SVsuport.org");</script><a href="mailto:SV_rentacar@SVsuport.org">SV_rentacar@SVsuport.org</a></li>
